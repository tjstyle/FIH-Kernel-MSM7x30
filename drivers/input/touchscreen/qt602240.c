...
{
	//MTD-BSP-colinTouch00+[
    //Div2-D5-Peripheral-FG-4Y6TouchPorting-00*[
#if defined(CONFIG_FIH_PROJECT_SF4Y6)
    uint8_t v16_T7[]  = { 32, 10, 50 };
    uint8_t v16_T8[]  = { 8, 0, 20, 20, 0, 0, 10, 35 };
    uint8_t v16_T9[]  = { 143, 0, 0, 19, 11, 0, 32, 50, 2, 5, 0, 5, 5, 47, 2, 10, 25, 0, 0x0, 0x0, 0x0, 0x0, 0, 0, 0, 0, 0, 0, 0, 0, 30 };
    ...
    uint8_t v16_T22[] = { 5, 0, 0, 0x1E, 0x0, 0xE2, 0xFF, 8, 16, 0, 0, 7, 10, 15, 20, 25, 8 };
